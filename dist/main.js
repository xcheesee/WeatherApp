...
const citiesWide1 = cities.slice(0, 5)
const citiesWide2 = cities.slice(5, 10)
console.log(cities, citiesWide1, citiesWide2)
...
function buildFutureForecast(wetrData) {
    ...
    // futureWeather.innerHTML =  `<div class="future-weather__day-ele">
    //                                 <h1 class="future-weather__day-header">${translateDayToPt(format(new Date(wetrData.list[0].dt_txt), 'eeee'))}</h1>
    //                                 <p class="future-weather__day-min">/${wetrData.list[0].main.temp_min}</p>
    //                                 <p class="future-weather__day-max">/${wetrData.list[0].main.temp_max}</p>
    //                             </div>`;
    futureWeather.innerHTML = wetrData.list.reduce((acc, val, index) => {
        ...
        acc += `<div class="future-weather__day-ele">
                    ...
                    <p class="future-weather__day-min">/${val.main.temp_min}</p>
                    <p class="future-weather__day-max">/${val.main.temp_max}</p>
                </div>`;
        return acc;
    }, '')
